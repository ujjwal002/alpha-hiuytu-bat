...
export default function HomePage() {
  ...
  // Motion config optimized for mobile - shorter durations, reduced easing
  const motionConfig = {
  ...
  return (
    <>
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        {/* Floating CTA - Simplified animation for mobile */}
        <motion.div
        ...
        <main>
          {/* HERO - Optimized: Preload critical images, reduced motion, no heavy JS here */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                >
                  <motion.span
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.2, duration: shouldReduceMotion ? 0.2 : 0.4 }}
                  >
                  ...
                  >
                    ...
                    <span className="text-blue-300">in Metro Detroit</span>
                  </h1>
                ...
                >
                  ...
                  <div className="text-center space-y-3 sm:space-y-4">
                    <motion.div
                      initial={{ scale: shouldReduceMotion ? 1 : 0.8 }}
                      animate={{ scale: 1 }}
                      transition={{ delay: 0.6, duration: shouldReduceMotion ? 0.2 : 0.4 }}
                    >
                    ...
                    <motion.div
                      ...
                      animate={{ scale: 1 }}
                      transition={{ delay: 0.8, duration: shouldReduceMotion ? 0.2 : 0.4 }}
                    >
          ...
          {/* STATS - Lightweight, no dynamic needed */}
