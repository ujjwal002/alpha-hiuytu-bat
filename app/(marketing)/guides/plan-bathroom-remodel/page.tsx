        ...
        <section className="bg-gray-900 py-16 px-4 text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight mb-5">
              How to Plan a Bathroom Remodel in <span className="text-gold-300">Metro Detroit</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-3 mt-8 max-w-2xl">
              <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-3">
                <Clock className="h-5 w-5 text-gold-300 mb-2" aria-hidden="true" />
                <p className="text-xs text-stonelux-300 font-semibold uppercase">Reading Time</p>
                <p className="text-base font-bold">8 minutes</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-3">
                <DollarSign className="h-5 w-5 text-gold-300 mb-2" aria-hidden="true" />
                <p className="text-xs text-stonelux-300 font-semibold uppercase">Budget Range</p>
                <p className="text-base font-bold">$8K – $60K+</p>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-3">
                <CheckCircle2 className="h-5 w-5 text-gold-300 mb-2" aria-hidden="true" />
                <p className="text-xs text-stonelux-300 font-semibold uppercase">Steps</p>
              ...
              {planBathroomRemodelSteps.map((step, i) => (
                ...
                >
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-gold-600 text-white rounded-xl flex items-center justify-center font-black text-lg">
                      {i + 1}
                    </div>
